    ...
    <div class="container py-3">
        <header>
            ...
            <div class="pricing-header p-3 pb-md-4 mx-auto text-center">
                <h1 class="display-4 fw-normal text-body-emphasis">Local storage</h1>
                <p class="fs-5 text-body-secondary">All songs are stored in database MySQL and can be seen just clicking on the button!</p>
            </div>
        </header>
        <main>
            <div class="pricing-header p-3 pb-md-4 mx-auto text-center">
